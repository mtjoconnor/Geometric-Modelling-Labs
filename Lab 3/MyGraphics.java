...
public class MyGraphics {
    ...
    private void drawPoint(Graphics g, int x, int y, int index)
    {
        int i = x;
        int j = y;
        int k = pointRadius;
    ...
    public void addPolyPoint(Graphics g, int x, int y)
    {
        ...
        drawPoint(g, x, y, thePoly.npoints-1);
    ...
    private void drawPolyPoints(Graphics g)
    {
        ...
        for (int i=0; i<thePoly.npoints; i++) {
            drawPoint(g, thePoly.xpoints[i], thePoly.ypoints[i], i);
        }
    }
